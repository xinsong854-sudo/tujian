...
window.HIGH_PERMISSION_USERS = [
    ...
    // 伪人档案
    '营长', '非常玦蝶', '化而为', '温塔莎▪克林斯曼', '独允', '西瓜人',
    'X', '亚契·谜思', '咔哒小姐', '荆千棘', '赫卡忒', '特洛菲', '洛洛',
    '医生', '多虫', '人魈', '凝胶', '汐', '涟', '渔夫', '圣地亚哥▪梅尔维尔',
    '拟人蝎', '深破', '希庇安', '安布罗斯', '无名卿', '因法勒', '伊露',
    '春山抚子', '伪抚', '小赤帽', '虫者', '林虫', '单先生', '笑颜', '陆玖',
    '长喙', '瀚羽', 'AT', '墨水夜', '冷寂', '石测', '大夜夜', '伽纳罗丝',
    '福音', '涂改', '阿秋', '鸿', '梦城寺绫希', '云蓝', '约斯米特', '瓦莉奥尔·阿亚奇',
    '折纸簌鸟', '红缇香', '牺牲', '兔仙', 'Эдельвейс', 'Cipher', '松下·拉尔', '江安', 'C.'
];
